...
let reasonn;
if(!reason) reasonn = ' **Neden belirtilmedi.**';
if(reason) reasonn = ` [ Sebep = **${reason}**  ].`;
...
.setDescription(`Üzgünüm modlar bu kanalı kilitlemek zorunda kaldı. ${reasonn} Lütfen bu karara saygı gösterin ve yakın zamanda yeniden açılabilir.`));
